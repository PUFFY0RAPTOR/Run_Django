...
class PersonasAdmin(admin.ModelAdmin):
    list_display = ('cedula', 'verFoto', 'nombre', 'apellido', 'celular', 'fecha_nacimiento', 'direccion', 'correo', 'contrasena', 'roles')
    search_fields = ['cedula', 'nombre', 'apellido', 'celular', 'fecha_nacimiento', 'direccion', 'correo', 'roles']
